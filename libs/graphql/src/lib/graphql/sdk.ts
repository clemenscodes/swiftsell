...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    getProductIDs(variables?: GetProductIDsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetProductIDsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProductIDsQuery>(GetProductIDsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getProductIDs', 'query');
    },
