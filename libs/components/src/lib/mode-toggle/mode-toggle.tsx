...
export const ModeToggle: React.FC<ModeToggleProps> = ({ ...props }) => {
    ...
    return (
        <Button onClick={toggleTheme} variant='ghost' size='sm'>
            <Icons.Sun className='hover:text-dimmed-900 ring- dark:text-dimmed-font dark:hover:text-dimmed-100 rotate-0 scale-100 transition-all dark:-rotate-90 dark:scale-0' />
